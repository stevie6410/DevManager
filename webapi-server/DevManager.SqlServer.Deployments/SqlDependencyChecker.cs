...
namespace DevManager.SqlServer.Deployments
{
    public class SqlDependencyChecker
    {
        private SqlConnectionConfiguration _connConfig;
        ...
        public List<ISqlObjectDependency> GetDependencies(string schemaName, string objectName)
        {
            List<ISqlObjectDependency> results = new List<ISqlObjectDependency>();
        ...
        public List<ISqlObjectDependency> GetDependencies(IEnumerable<IDbObject> objects)
        {
            var results = new List<ISqlObjectDependency>();
